...
```
    "start-coverage": "ui5 serve --port 8065 --config ui5-coverage.yaml",
    ...
    "test-runner-coverage": "ui5-test-runner --url http://localhost:8065/test/testsuite.qunit.html --coverage -ccb 60 -ccf 100 -ccl 80 -ccs 80",
    "test-ui5": "ui5-test-runner --start start-coverage --url http://localhost:8065/test/testsuite.qunit.html --coverage -ccb 60 -ccf 100 -ccl 80 -ccs 80",
```

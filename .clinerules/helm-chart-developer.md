...
1. Get the application URL by running:
  ...
  kubectl --namespace {{ .Release.Namespace }} port-forward $POD_NAME 8065:{{ .Values.service.targetPort }}
  echo "Visit http://127.0.0.1:8065"
{{- end }}
```
...
### .NET
- Default port: `8065` (ASP.NET Core 8+) or `80` (earlier)
